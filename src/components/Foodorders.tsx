...
const Foodorders = ({ user, setAlerts }: UsersProps) => {
  ...
  const menu = [
    ...
    },
    {
      ...
      description: "Marinert Kylling i pitabrød.",
      img: "https://smakfullpbk.com/wp-content/uploads/2021/10/Syrisk-Shawarma-Kylling-Rull-i-Norge.jpg",
      sizes: ["Normal", "Large"],
      spice: ["Mild", "Medium", "Medium+", "Sterk"],
      extra: [
    ...
    },
    {
      ...
      description: "Marinert Kylling i hvete-tortilla",
      img: "https://ministryofcurry.com/wp-content/uploads/2021/05/chicken-shawarma-6.jpg",
      sizes: ["Normal", "Large"],
      spice: ["Mild", "Medium", "Medium+", "Sterk"],
      extra: [
    ...
    },
    {
      ...
      prices: ["???", "175", "???"],
        ...
        {
      name: "Smash burger",
      description: "Smash burger med salat og dressing.",
    ...
    {
      name: "Smash burger Tallerken",
      description: "Smash burger med pommes ved siden av.",
